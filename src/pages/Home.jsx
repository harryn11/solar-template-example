                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <Link to="/services/solar" className="flex flex-col gap-6 group">
                            <div className="overflow-hidden rounded-3xl h-48 relative border border-primary/20 bg-dark">
                                <img src="https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?q=80&w=1024&auto=format&fit=crop" alt="Solar Panels" className="w-full h-full object-cover opacity-70 group-hover:scale-105 transition-transform duration-700" />
                        ...
                        <Link to="/services/ev" className="flex flex-col gap-6 group">
                            <div className="overflow-hidden rounded-3xl h-48 relative border border-primary/20 bg-dark">
                                <img src="https://images.unsplash.com/photo-1593941707882-a5bba14938c7?q=80&w=1024&auto=format&fit=crop" alt="EV Charging" className="w-full h-full object-cover opacity-70 group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-dark/90 to-transparent"></div>
                            </div>
                            <div>
